...
BOOST_FIXTURE_TEST_CASE( test_average_calculations, worbli_resource_tester, * boost::unit_test::tolerance(1e+2) ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-19T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-20T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-21T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-22T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-23T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-09-24T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
...
BOOST_FIXTURE_TEST_CASE( test_resource_oracle, worbli_resource_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2020-01-01T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   BOOST_REQUIRE_EQUAL( success(), settotal("worbli.admin", 0.005, 0.005, "2020-01-01T00:00:00.000") );

   BOOST_REQUIRE_EQUAL( success(), setmetric( "2020-01-02T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), setmetric( "2019-12-15T00:00:00.000", "10000.0000 WBI", "2500.0000 WBI" ) );
