...
worbli system newaccount worbli.admin --transfer providers EOS7Twda1EMGC1FYH2o9d7APfmwZAMtN3e69wQg1CPjBqQSaWH39P --stake-net "5.0000 WBI" --stake-cpu "10.0000 WBI" --buy-ram-kbytes 100
...
worbli push action provider1 addentry '["identity", "kyc based identity verification"]' -p provider1
